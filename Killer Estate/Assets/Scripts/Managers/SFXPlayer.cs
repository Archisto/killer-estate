...
// README:
// Create a prefab of this and put it in Prefabs>Resources folder.
// For each sound clip, there must be a corresponding name in the
// Sound enum in the correct order. The volume can be controlled with
