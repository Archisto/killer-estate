...
using UnityEngine;
using KillerEstate.WaypointSystem;
...
namespace KillerEstate
{
    public class FollowPath : Motion
    {
        ...
        protected override void UpdateCurrentSpeed()
        {
            ...
            if (_active)
            {
                SpeedRatio += _acceleration * GameManager.Instance.DeltaTime;
            ...
            {
                SpeedRatio += _deceleration * GameManager.Instance.DeltaTime;
        ...
        private bool MoveUsingSpeed(Vector3 waypointPos, bool leftOverOnly)
        {
            ...
            {
                movingDistance = CurrentSpeed * GameManager.Instance.DeltaTime;
